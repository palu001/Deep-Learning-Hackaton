...
state = torch.load("/home/palu001/Github/Deep-Learning-Hackaton/model_B_best_acc.pth", map_location="cpu")
...
# Istanzia il modello
model = GNNLightning(gnn='gin-virtual', dataset_name='B', loss_n =1, weight_decay = True, num_layer = 5, emb_dim = 300, drop_ratio = 0.5)

# Carica i pesi modificati nel modello
model.load_state_dict(new_state_dict)

# Salva il nuovo checkpoint .ckpt
checkpoint_path = "/home/palu001/Github/Deep-Learning-Hackaton/model_B_best_acc.ckpt"
torch.save({
